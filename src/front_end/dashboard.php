...
<head>
  ...
  <script type='text/javascript' src='dashboard_map.js' async></script>
  <script type='text/javascript' src='over_map.js' async></script>
  <script type='text/javascript' src='geoxml3.js' async></script>
</head>
<body>
  <div id="target"></div>
  <div id="over_map">
